...
class CustomSnackBar {
  // ── Versi dengan BuildContext (untuk semua halaman) ───────────────────────
  static void show(BuildContext context, String message, Color color) {
    final cfg = _resolveConfig(color);
    ScaffoldMessenger.of(context)
      ..clearSnackBars()
      ..showSnackBar(_buildSnackBar(cfg, message));
  }

  // ── Versi dengan GlobalKey (untuk service layer tanpa BuildContext) ────────
  ...
  // ── Resolve config dari warna ─────────────────────────────────────────────
  static _SnackConfig _resolveConfig(Color color) {
