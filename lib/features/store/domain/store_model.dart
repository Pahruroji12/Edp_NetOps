/// StoreModel — representasi data toko dari Supabase.
///
/// Lokasi: features/store/domain/store_model.dart
///
class StoreModel {
  final String id;
  ...
  // ── Service ID ────────────────────────────────────────────────
  final String? sidUtama;
  final String? sidBackup;
  ...
  factory StoreModel.fromJson(Map<String, dynamic> json) {
    return StoreModel(
      ...
      sidUtama: json['sid_utama'],
      sidBackup: json['sid_backup'],
