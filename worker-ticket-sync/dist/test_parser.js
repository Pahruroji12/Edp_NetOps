...
const candidates = (0, ticketParser_1.extractStoreCodes)(searchString);
console.log("Candidate store codes found:", candidates);
const ticketNo = (0, ticketParser_1.extractTicketNumber)("Astinet", searchString);
...
( No Ticket REWRRQ36 )
`;
console.log("ICON Case 1 (REW):", (0, ticketParser_1.extractTicketNumber)("ICON", iconEmailBody1)); // Expected: REWRRQ36
const iconEmailBody2 = `
Nama Pelanggan : PT. INDOMARCO PRISMATAMA
( No Ticket RENEXRH3 )
`;
console.log("ICON Case 2 (REN):", (0, ticketParser_1.extractTicketNumber)("ICON", iconEmailBody2)); // Expected: RENEXRH3
const iconEmailBody3 = `
(NoTicket: CS-123456789)
`;
console.log("ICON Case 3 (CS- with colon):", (0, ticketParser_1.extractTicketNumber)("ICON", iconEmailBody3)); // Expected: CS-123456789
const iconEmailBody4 = `
Nomor tiket gangguan Anda adalah ID-987654321
`;
console.log("ICON Case 4 (Fallback ID-):", (0, ticketParser_1.extractTicketNumber)("ICON", iconEmailBody4)); // Expected: ID-987654321
