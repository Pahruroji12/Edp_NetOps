...
console.log("T567:", extractStoreCodes("toko T567 di Lebak")); // [T567]
console.log("TGPJ:", extractStoreCodes("toko TGPJ Raya")); // [TGPJ]
console.log("FRS9:", extractStoreCodes("toko FRS9 RUKO SEION")); // [FRS9]
console.log("T1LX:", extractStoreCodes("toko T1LX SADELI")); // [T1LX]
console.log("T119:", extractStoreCodes("toko T119 WARUNG JAUD")); // [T119]
...
`;
console.log("RRV (dari screenshot):", extractTicketNumber("ICON", iconRRV));
// Expected: RRV73GZY
...
( No Ticket REWRRQ36 )
`;
console.log("REW:", extractTicketNumber("ICON", iconREW));
// Expected: REWRRQ36
...
( No Ticket RENEXRH3 )
`;
console.log("REN:", extractTicketNumber("ICON", iconREN));
// Expected: RENEXRH3

const iconCS = `(NoTicket: CS-123456789)`;
console.log("CS-:", extractTicketNumber("ICON", iconCS));
...
`;
console.log("INC:", extractTicketNumber("Astinet", astinetBody));
...
console.log("Store codes from subject:", extractStoreCodes(iconSubject));
